...
////////// STREAM ////////////////////////////////
  ...
  async function stream(t, suid, ctx=null) {
...
b.remove();\
        ...
        try{
          ...
          let sctx = {  
                        server: { write, suid }, //needed by serverFetch: suid for "internal" authentication and write to stream _data_ for client side hydration
                        session: ctx, //{ uid, url:ctx.url, user:ctx.user },
                      };
